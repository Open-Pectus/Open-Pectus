...
export class ProcessUnitService {
    ...
    /**
     * Get All Process Values Of All Available Engines
     * Returns all process value for all online process units (engines)
     * that the current user has access to.
     * @param data The data for the request.
     * @param data.xIdentity
     * @returns ProcessUnitAllProcessValues Successful Response
     * @throws ApiError
     */
    public getAllProcessValuesOfAllAvailableEngines(data: GetAllProcessValuesOfAllAvailableEnginesData = {}): Observable<GetAllProcessValuesOfAllAvailableEnginesResponse> {
        return __request(OpenAPI, this.http, {
            method: 'GET',
            url: '/api/process_units/all_process_values',
            headers: {
                'x-identity': data.xIdentity
            },
            errors: {
...
export class RecentRunsService {
    ...
    /**
     * Get Recent Run Archive
     * @param data The data for the request.
     * @param data.runId
     * @param data.xIdentity
     * @returns RecentRunArchive Successful Response
     * @throws ApiError
     */
    public getRecentRunArchive(data: GetRecentRunArchiveData): Observable<GetRecentRunArchiveResponse> {
        return __request(OpenAPI, this.http, {
            method: 'GET',
            url: '/api/recent_runs/{run_id}/archive',
            path: {
                run_id: data.runId
            },
            headers: {
...
export class WebpushService {
     ...
     * @throws ApiError
     */
    public testNotification(data: TestNotificationData = {}): Observable<TestNotificationResponse> {
        return __request(OpenAPI, this.http, {
            method: 'POST',
            url: '/api/webpush/test_notification',
            headers: {
                'x-identity': data.xIdentity
            },
            errors: {
