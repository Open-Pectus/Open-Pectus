...
export type MethodState = {
    ...
    content_locked_line_ids: Array<string>;
...
export type PubSubTopic = 'run_log' | 'method' | 'method_state' | 'control_state' | 'error_log' | 'process_units' | 'active_users' | 'dead_man_switch';
...
export type GetPcodeTmGrammarResponse = (unknown);
...
export type GetActiveUsersResponse = (Array<ActiveUser>);
...
export type RegisterActiveUserResponse = (unknown);
...
export type UnregisterActiveUserResponse = (unknown);
