...
- [7. Protocols](#7-protocols)
  ...
  - [7.3 State diagrams](#73-state-diagrams)
    ...
    - [7.3.2 Interpreter states](#732-interpreter-states)
    - [7.3.3 Aggregator states](#733-aggregator-states)
  - [7.9 Aggregator states per engine](#79-aggregator-states-per-engine)
...
stateDiagram-v2  
  ...
  Disconnected --> Disconnected: [register denied]
  Registered --> Connected: [connect ok]
  Registered --> Disconnected: [connect error]
...
Inject before method start , what states are engine and interpreter in?
