...
class RecentRun(DBModel):
    ...
    uod_filename: Mapped[str] = mapped_column(nullable=True)
    uod_author_name: Mapped[str] = mapped_column(nullable=True)
    uod_author_email: Mapped[str] = mapped_column(nullable=True)
