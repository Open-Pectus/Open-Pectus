...
class FromEngine:
    ...
    def engine_reconnected(self, msg: EM.ReconnectedMsg):
        ...
        raise NotImplementedError("TODO review this")
    ...
    def run_started(self, msg: EM.RunStartedMsg):
        ...
        if engine_data.run_data is None:
            ...
            engine_data.run_data = Mdl.RunData.empty(
                run_id=msg.run_id,
                run_started=datetime.fromtimestamp(msg.run_started_tick, timezone.utc)
            )
    ...
    def ___run_id_changed(
        ...
        raise NotImplementedError("Not doing this anymore")
