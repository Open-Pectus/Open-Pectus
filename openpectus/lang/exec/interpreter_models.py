...
class InterpreterState:
    ...
    method: ParserMethod  # Method in opruntime - not sure whether to use ParserMethod or Method
    ...
    def compare(a: InterpreterState, b: InterpreterState, include_export_date=False) -> list[str]:
        ...
        result_lines.extend(ParserMethod.compare(a.method, b.method))
        a_lines = _serialize(a.tree_state).splitlines()
        b_lines = _serialize(b.tree_state).splitlines()
...
def _serialize(obj) -> str:
    ...
    def serialize_dict_values(obj):
        ...
        elif isinstance(obj, ParserMethod):
            return obj.as_json()
